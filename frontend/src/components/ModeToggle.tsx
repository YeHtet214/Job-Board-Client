            ...
            {open && (
                <ul className="absolute -bottom-5 left-0 lg:right-0 lg:-translate-x-[50%] translate-y-[100%] bg-jb-surface min-w-20 shadow-lg z-100 rounded">
                    <li
                        ...
                        className={`py-2 px-4 cursor-pointer flex items-center hover:opacity-80 hover:text-jb-primary ${theme === 'light' && 'text-jb-primary'}`}
                    >
                    ...
                    <li
                        ...
                        className={`py-2 px-4 cursor-pointer flex items-center hover:opacity-80 hover:text-jb-primary ${theme === 'dark' && 'text-jb-primary'}`}
                    >
