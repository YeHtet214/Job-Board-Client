...
const EmployerDashboard: React.FC = () => {
    ...
    const [companyProfileComplete, setCompanyProfileComplete] =
        useState<boolean>(false)
    const [companyProfilePercentage, setCompanyProfilePercentage] =
        useState<number>(0)
                                ...
                                <CardHeader>
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <CardDescription>
                                                Manage your active and past job
                                                postings
                                            </CardDescription>
                                        </div>
                                        <Button
                        ...
                        <TabsContent value="applications">
                            <Card className="bg-jb-surface text-jb-text">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Applications received for your job
                                        postings
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                    ...
                    <div className="mt-6">
                        <ProfileCompletionCard
                            ...
                            completionItems={[
                                {
                                    completed: true,
                                    text: 'Basic company information added',
                                },
                                {
                                    completed: true,
                                    text: 'Company location set',
                                },
                                {
                                ...
                                {
                                    completed: companyProfileComplete,
                                    text: 'Complete company description',
                                },
                            ]}
