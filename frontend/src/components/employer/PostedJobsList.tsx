                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {onDeleteJob && (
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent
                                                align="end"
                                                className="bg-jb-surface shadow p-2"
                                            >
                                                <DropdownMenuItem
                                                    className="border-b hover:border-b-jb-primary hover:text-blue-500"
                                                    onClick={() =>
                                                        navigate(
                                                            `/jobs/${job.id}/edit`
                                                        )
                                                ...
                                                <DropdownMenuItem
                                                    className="border-b hover:border-b-jb-primary hover:text-jb-primary"
                                                    onClick={() =>
                                                        navigate(
