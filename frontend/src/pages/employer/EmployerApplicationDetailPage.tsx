                    ...
                    <Card className="flex-1">
                        <CardContent className="p-4 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <Badge
                                    className={`mt-1 ${statusColorMap[application.status]}`}
                                >
                                ...
                                <CardContent>
                                    {application.resumeUrl ? (
                                        ...
                                        <div className="border border-dashed rounded-lg p-4 text-center">
                                            <p className="text-sm text-muted-foreground">
                                                No resume was uploaded with this
                                                application
                                            </p>
                                        </div>
                                    )}
                                ...
                                <Card className="md:col-span-2">
                                    ...
                                    <CardContent className="space-y-4">
                                        <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
                                            <p className="text-sm">
                                                This application is currently in
                                                the interview stage. You may
                                                want to contact the applicant to
                                                schedule an interview or provide
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            {application.applicant?.firstName}{' '}
                            {application.applicant?.lastName}'s application
                        </DialogDescription>
                    </DialogHeader>
