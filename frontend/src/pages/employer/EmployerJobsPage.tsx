...
const EmployerJobsPage: React.FC = () => {
    ...
    const { data: jobsData, isLoading: isJobsLoading } = useCompanyJobs(
        company?.id || ''
    )
    ...
    const handleDeleteJob = async () => {
        ...
        try {
            ...
            // Show error message
            window.alert(
                'There was a problem deleting the job posting. Please try again.'
            )
        } finally {
            setJobToDelete(null)
    ...
    return (
        <div className="container mx-auto max-w-6xl py-10 px-4 sm:px-6">
            ...
            >
                <h1 className="text-3xl font-bold text-jb-primary">
                    Your Job Postings
                </h1>
                <Button
                ...
                >
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                View, edit, and track applications for your
                                posted jobs
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            {companyJobs && companyJobs.length > 0 ? (
                                        ...
                                        >
                                            <div className="flex flex-col md:!flex-row md:!justify-between md:!items-start gap-4 mb-4">
                                                <div className="flex-1">
                                                    <h3 className="text-xl font-medium text-jobboard-darkblue">
                                                        {job.title}
                                                    </h3>
                                ...
                                >
                                    ...
                                    <p className="text-gray-500 mb-6">
                                        Start posting jobs and find the perfect
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            delete the job posting and remove it from our
                            servers.
                        </DialogDescription>
                    </DialogHeader>
